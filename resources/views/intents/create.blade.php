...
@section('title', 'Tambah Intent Baru')
    ...
    <div class="p-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            <div class="flex items-center gap-3 mb-6 pb-6 border-b border-gray-200">
                ...
                <h1 class="text-2xl font-bold text-gray-800">Tambah Intent Baru</h1>
            </div>
            ...
            <form action="{{ route('intents.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="2"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                        placeholder="Deskripsi singkat tentang intent ini">{{ old('description') }}</textarea>
                </div>
                ...
                <div class="bg-purple-50 rounded-lg p-6 border border-purple-100">
                    ...
                    <div id="responses-container" class="space-y-3">
                        ...
                        @else
                            <div class="flex gap-2 items-start response-row">
                                <span
                                    class="bg-purple-600 text-white w-8 h-10 flex items-center justify-center rounded-lg text-sm font-semibold flex-shrink-0">1</span>
                                <textarea name="responses[]" rows="2" required
                                    class="flex-1 px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
